      ...
      <div class="col-lg-9">
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="nav-dalle" role="tabpanel" aria-labelledby="nav-dalle-tab" tabindex="0">
            ...
            <fieldset class="border rounded-2 p-3 mb-4">
              <legend><h5>Choose a version of DALL-E to use</h5></legend>
              <div class="row align-middle">

                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <select name="dalle_version" class="form-select" id="floatingSelectDallEVersion" required>
                      <option value="2" <?php echo $get->dalle_version == 2 ? 'selected' : ''; ?>>DALL-E2</option>
                      <option value="3" <?php echo $get->dalle_version == 3 ? 'selected' : ''; ?>>DALL-E3</option>
                    </select>
                    <label for="floatingSelectDallEVersion">Select DALL-E Version</label>
                  </div>
                </div>
            ...
            <fieldset class="border rounded-2 p-3 mb-4">
              <legend><h5><i class="bi bi-card-image"></i> DALL·E 3 Configs</h5></legend>
              <p class="mt-0 mb-1">For now DALL-E3 only supports 1 image at a time.</p>
              <div class="row align-middle">

                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <input name="dalle3_spend_credits" type="number" class="form-control" placeholder="Amount of credits to be spent to generate the image pack" value="<?php echo $get->dalle3_spend_credits; ?>" required>
                    <label>Amount of credits to be spent to generate the image pack</label>
                  </div>
                </div>

                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <select name="dalle3_img_size" class="form-control" required>
                      <?php
                      $dalle_img_size1 = ['1024x1024', '1024x1792','1792x1024'];
                      $selectedDalle3ImgSize = $get->dalle3_img_size;

                      foreach ($dalle_img_size1 as $dalle3_img_size) {
                        $selected = $dalle3_img_size == $selectedDalle3ImgSize ? 'selected' : '';
