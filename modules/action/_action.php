...
if (isset($_POST['action'])) {
  ...
  require_once("../../vendor/autoload.php");
    ...
    if ($_POST['action'] == "create-account") {
      ...
      if (empty($_POST['email']) || empty($_POST['password']) || empty($_POST['phone']) || empty($_POST['name'])) {
      ...
      $_SESSION['form_parent_email'] = $_POST['parent_email'];
      $_SESSION['form_phone'] = $_POST['phone'];
      $_SESSION['form_country'] = $_POST['country'];
      $_SESSION['form_role'] = $_POST['role'];
      $_SESSION['form_school'] = $_POST['form_school'];
      ...
      if($customers->add()){
        ...
        unset($_SESSION['form_country']);
        unset($_SESSION['form_role']);
        unset($_SESSION['form_school']);
